...
# OPDRACHT:
# Schrijf je eigen versie van schaar-steen-papier tegen de computer
...
#    (gebruik de functie lower() op je input)

# TIP: volgende functies moet je gebruiken uit de random module:
# random.choice(lijst) - kiest een willekeurig element uit een lijst of tuppel
